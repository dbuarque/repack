...
describe('Repack', function() {
    ...
    it('#create() - Create a react webpack app');
    it('#create() - Create a react / redux webpack app');
    it('#create() - Create a react / tdd / bdd app');
    it('#create() - Create a react / redux / tdd / bdd app');
